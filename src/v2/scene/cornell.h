...
void sceneCornellBox() {
    ...
    HittableList world{};
    world.add(std::make_shared<Quad>(Point{0, 0, 0}, Vec3{555, 0, 0}, Vec3{0, 0, 555}, white));
    world.add(std::make_shared<Quad>(Point{0, 0, 0}, Vec3{0, 555, 0}, Vec3{0, 0, 555}, red));
    world.add(std::make_shared<Quad>(Point{555, 0, 0}, Vec3{0, 555, 0}, Vec3{0, 0, 555}, green));
