...
int main() {
    ...
    world.add(std::make_shared<krt::Sphere>(
        krt::Point{-2, 0.0, 0.4}, 1, std::make_shared<krt::Lambertian>(krt::Color{0.7, 0.7, 0.8})
    ));
    world.add(std::make_shared<krt::Sphere>(
        krt::Point{0, 0, 1}, 1, std::make_shared<krt::Metal>(krt::Color{0.9, 0.9, 0.9}, 0.5)
    ));
    world.add(std::make_shared<krt::Sphere>(
